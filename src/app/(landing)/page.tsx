        ...
        <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-20">
          ...
          <div className="grid gap-4 lg:grid-cols-3 lg:grid-rows-2">
            <div className="relative lg:row-span-2">
              ...
              <div className="rounded-[calc(theme(borderRadius.lg)+1px)]lg:rounded-l-[calc(2rem+1px)] relative flex h-full flex-col overflow-hidden">
            ...
            <div className="relative lg:row-span-2">
              ...
              <div className="rounded-[calc(theme(borderRadius.lg)+1px))] relative flex h-full flex-col overflow-hidden max-lg:rounded-b-[calc(2rem+1px)] lg:rounded-r-[calc(2rem+1px)]">
                <div className="px-8 pb-3 pt-8 sm:px-10 sm:pb-0 sm:pt-10">
                  <p className="mt-2 text-lg/7 font-medium tracking-tight text-brand-950 max-lg:text-center">
                    Easy Integration
                  </p>
                ...
                <div className="relative min-h-[30rem] w-full grow">
                  <div className="absolute bottom-0 left-10 right-0 top-10 overflow-hidden rounded-tl-xl bg-gray-900">
