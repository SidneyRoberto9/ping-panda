...
export default function Page() {
  ...
  return (
    <div className="py-25 bg-brand-25 sm:py-32">
      <MaxWidthWrapper>
        ...
        <div className="mx-auto mt-16 max-w-2xl rounded-3xl bg-white ring-1 ring-gray-200 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none">
          <div className="p-8 sm:p-10 lg:flex-auto">
            ...
            <div className="mt-10 flex items-center gap-x-4">
              <h4 className="flex-one text-sm/6 font-semibold text-brand-600">
                What's included
              </h4>
              <div className="h-px flex-auto bg-gray-100" />
            </div>

            <ul className="text-grau-600 mt-8 grid grid-cols-1 gap-4 text-sm/6 sm:grid-cols-2 sm:gap-6">
